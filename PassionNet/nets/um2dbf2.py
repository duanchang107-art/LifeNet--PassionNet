...
class Unet(nn.Module):
    def __init__(self, num_classes=21, pretrained=False, backbone='vgg'):
        ...
        key_channels = 128
        self.FBF_layer1 = FBF_Layer(64, 64, num_iter, [3])
        self.FBF_layer2 = FBF_Layer(64, 64, num_iter, [5])
    ...
    def forward(self, inputs):
        ...
        x5_dem_1_up_map1 = self.FBF_layer1(x5_dem_1_up)
        ...
        x5_dem_1_up_map1 = self.conv_3(x5_dem_1_up)
        x4_dem_1_map1 = self.FBF_layer1(x4_dem_1)
        x5_dem_1_up_map2 =self.FBF_layer2(x5_dem_1_up)
        x4_dem_1_map2 = self.FBF_layer2(x4_dem_1)
        x5_4 = self.x5_x4(
        ...
        x4_dem_1_up_map1 = self.FBF_layer1(x4_dem_1_up)
        x3_dem_1_map1 = self.FBF_layer1(x3_dem_1)
        x4_dem_1_up_map2 = self.FBF_layer2(x4_dem_1_up)
        x3_dem_1_map2 =self.FBF_layer2(x3_dem_1)
        x4_3 = self.x4_x3(
        ...
        x3_dem_1_up_map1 = self.FBF_layer1(x3_dem_1_up)
        x2_dem_1_map1 = self.FBF_layer1(x2_dem_1)
        x3_dem_1_up_map2 = self.FBF_layer2(x3_dem_1_up)
        x2_dem_1_map2 = self.FBF_layer2(x2_dem_1)
        x3_2 = self.x3_x2(
        ...
        x2_dem_1_up_map1 = self.FBF_layer1(x2_dem_1_up)
        x1_map1 = self.FBF_layer1(x1)
        x2_dem_1_up_map2 = self.FBF_layer2(x2_dem_1_up)
        x1_map2 = self.FBF_layer2(x1)
        ...
        x5_4_up_map1 = self.FBF_layer1(x5_4_up)
        x4_3_map1 = self.FBF_layer1(x4_3)
        x5_4_up_map2 = self.FBF_layer2(x5_4_up)
        x4_3_map2 = self.FBF_layer2(x4_3)
        ...
        x4_3_up_map1 = self.FBF_layer1(x4_3_up)
        x3_2_map1 = self.FBF_layer1(x3_2)
        x4_3_up_map2 = self.FBF_layer2(x4_3_up)
        x3_2_map2 = self.FBF_layer2(x3_2)
        ...
        x3_2_up_map1 = self.FBF_layer1(x3_2_up)
        x2_1_map1 = self.FBF_layer1(x2_1)
        x3_2_up_map2 = self.FBF_layer2(x3_2_up)
        x2_1_map2 = self.FBF_layer2(x2_1)
        ...
        x5_4_3_up_map1 =self.FBF_layer1(x5_4_3_up)
        x4_3_2_map1 = self.FBF_layer1(x4_3_2)
        x5_4_3_up_map2 =self.FBF_layer2(x5_4_3_up)
        x4_3_2_map2 = self.FBF_layer2(x4_3_2)
        ...
        x4_3_2_up_map1 = self.FBF_layer1(x4_3_2_up)
        x3_2_1_map1 = self.FBF_layer1(x3_2_1)
        x4_3_2_up_map2 = self.FBF_layer2(x4_3_2_up)
        x3_2_1_map2 = self.FBF_layer2(x3_2_1)
        ...
        x5_dem_4_up_map1 = self.FBF_layer1(x5_dem_4_up)
        x4_3_2_1_map1 = self.FBF_layer1(x4_3_2_1)
        x5_dem_4_up_map2 = self.FBF_layer2(x5_dem_4_up)
        x4_3_2_1_map2 =self.FBF_layer2(x4_3_2_1)
