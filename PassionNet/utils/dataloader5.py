...
class UnetDataset_point(Dataset):
    def __init__(self, annotation_lines, input_shape, num_classes, train, dataset_path):
        super(UnetDataset_point, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        png = Image.open(os.path.join(os.path.join(self.dataset_path, "cp3"), name + ".png"))
...
def unet_dataset_collate_point(batch):
    images = []
    pngs = []
    pngs2=[]
