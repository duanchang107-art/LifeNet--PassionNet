...
class UnetDataset_full(Dataset):
    def __init__(self, annotation_lines, input_shape, num_classes, train, dataset_path):
        super(UnetDataset_full, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        #   从文件中读取图像
        # -------------------------------#
        jpg = Image.open(os.path.join(os.path.join(self.dataset_path, "crop_image"), name + ".png"))
        png = Image.open(os.path.join(os.path.join(self.dataset_path, "crop_mk2"), name + ".png"))
        png_2 = Image.open(os.path.join(os.path.join(self.dataset_path, "crop_mk2"), name + ".png"))
...
def unet_dataset_collate_full(batch):
    images = []
    pngs = []
    pngs2=[]
    
    for img, png,png2 in batch:
        images.append(img)
        pngs.append(png)
        pngs2.append(png2)
    ...
    pngs2 = torch.from_numpy(np.array(pngs2)).long()
   
    return images, pngs,pngs2