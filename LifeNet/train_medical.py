...
if __name__ == "__main__":
    ...
    if local_rank == 0:
        show_config(
            ...
            save_period = save_period, save_dir = run_save_dir, num_workers = num_workers, num_train = num_train
        )
    #------------------------------------------------------#
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch_no_val(model_train, model, loss_history, optimizer, epoch, epoch_step, gen, UnFreeze_Epoch, Cuda, dice_loss, focal_loss, cls_weights, num_classes, fp16, scaler, save_period, run_save_dir, local_rank)
